 ...
 ***************************************************************************/
	...
	define('ONPHP_ROOT_PATH', PATH_LIB . "onphp" .DIRECTORY_SEPARATOR);
	
	require
		ONPHP_ROOT_PATH.DIRECTORY_SEPARATOR
	...
	define('ONPHP_LIB_PATH', PATH_LIB . "onphplib" .DIRECTORY_SEPARATOR);
